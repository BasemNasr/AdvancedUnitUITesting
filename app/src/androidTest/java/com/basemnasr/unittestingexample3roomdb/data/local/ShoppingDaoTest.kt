package com.basemnasr.unittestingexample3roomdb.data.local
...
import com.basemnasr.unittestingexample3roomdb.ui.ShoppingFragment
...
//    }
    ...
    fun insertShoppingItem() = runBlockingTest {
        val shoppingItem = ShoppingItem("Bassem", 1, 1f, "url", id = 1)
    ...
    fun observeTotalPriceSum() = runBlockingTest {
        ...
        assertThat(totalPriceSum).isEqualTo(2 * 5f + 4 * 5.5f)
    }
}